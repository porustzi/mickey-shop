      ...
      <div className="max-w-screen-xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[10px] font-mono tracking-[0.3em] uppercase text-cyber-blue/60 border border-cyber-blue/20 px-2 py-0.5">
                UA
              </span>
            ...
            <p className="text-white/35 text-sm leading-relaxed max-w-xs">
              Curated resale. Streetwear, sneakers, vintage. No noise — only the good stuff.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <span>Telegram</span>
                  <span className="text-[10px] text-white/20">@void_store</span>
                </a>
              </li>
              <li>
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/20 text-xs font-mono tracking-wider">
            &copy; {new Date().getFullYear()} VOID — All items are resale
          </p>
